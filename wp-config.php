 ...
 */
  ...
  if (isset($_ENV['PANTHEON_ENVIRONMENT'])):
      $redirectThis = $_SERVER['REQUEST_URI'];
      if(startsWith($redirectThis, '/view')
            || startsWith($redirectThis, '/browse')
            || startsWith($redirectThis, '/subscribe')
            || startsWith($redirectThis, '/authorize')
            || startsWith($redirectThis, '/partner')
            || startsWith($redirectThis, '/buy')) {
          header( 'Location: https://members.drbeen.com'.$_SERVER['REQUEST_URI'], TRUE, 301) ;
          exit;
      }
