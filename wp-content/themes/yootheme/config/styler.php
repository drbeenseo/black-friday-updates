...
return [
    ...
    'section' => [
        ...
        'hover' => [
            'theme' => '.tm-page, .tm-toolbar, .tm-sidebar, .tm-headerbar-top, .tm-headerbar-bottom, .tm-headerbar-stacked, .tm-section-title',
            ...
            'utility' => '.uk-panel-scrollable, .uk-height-small, .uk-height-medium, .uk-height-large, .uk-box-shadow-bottom, .uk-dropcap, .uk-leader, .uk-logo',
            'width' => '.uk-width-small, .uk-width-medium, .uk-width-large, .uk-width-xlarge, .uk-width-xxlarge',
        ],

        'inspect' => [
            'theme' => '.tm-page-container, .tm-page, tm-page > *, .tm-toolbar, .tm-toolbar > *, .tm-sidebar, .tm-sidebar > *, .tm-headerbar-top, .tm-headerbar-top > *, .tm-headerbar-bottom, .tm-headerbar-bottom > *, .tm-headerbar-stacked, .tm-headerbar-stacked > *, .tm-section-title, .tm-section-title > *',
            ...
            'utility' => '.uk-panel-scrollable, .uk-panel-scrollable > *, .uk-height-small, .uk-height-small > *, .uk-height-medium, .uk-height-medium > *, .uk-height-large, .uk-height-large > *, .uk-box-shadow-bottom, .uk-dropcap, .uk-leader, .uk-logo, .uk-logo > *',
