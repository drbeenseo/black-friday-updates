...
class AnimatedGif {
    ...
    function __construct(
        array $source_images, array $image_delays, $number_of_loops, $transparent_colour_red = -1,
        $transparent_colour_green = -1, $transparent_colour_blue = -1) {
     ...
     * @return type
     */
    public  function display($gifFileName) {
        //late footer add
        $this->addFooter();
        //header('Content-type:image/gif');

        file_put_contents($this->gifsPath() . "/" . $gifFileName . ".gif", $this->image);

        return get_home_url() . "/wp-content/plugins/wp-deadlines/includes/gif-generator/storage/gifs/" . $gifFileName . ".gif";
    }
     ...
     * @return string
     */
    protected function gifsPath()
    {
        return realpath(__DIR__ . '/../storage/gifs');
    }
}
