...
class uptin_active_campagin
{
  ...
  private function uptin_qualify_form($response){
  ...
  public function uptin_submit_ac_form($form_id, $first_name, $last_name, $email, $lists_array, $url ){
	...
	$names_array = uptin_name_splitter($first_name, $last_name);
