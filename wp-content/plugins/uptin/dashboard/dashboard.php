...
class EWD_Dash {
	...
	public static function load_fonts_class() {
		if ( ! class_exists( 'EWD_Dash_Fonts' ) ) {
			require_once( RAD_DASHBOARD_DIR . 'includes/google_fonts.php' );
		}

		$fonts_class = new EWD_Dash_Fonts();
	...
	function rad_dashboard_activate_screen() {
		...
		update_option('rad_uptin_activated_code', $code);
		...
		if ( empty( $results ) ) {
			if ( 'true' === $full_content ) {
				$output .= sprintf(
					...
					esc_html__( 'No results found', 'uptin' )
				);
			}
		} else {
	...
	function process_and_update_options( $options, $option_sub_title = '' ) {
		...
		EWD_Dash::update_option( $final_array );
	...
	function generate_options_page( $sub_array = '' ) {
		include_once(EWD_UPTIN_PLUGIN_DIR.'includes/static_content/marketing_sidebar.php');
		$this->dashboard_options = $this->get_options_array();
		$dashboard_options = $this->dashboard_options;
		$dashboard_sections = $this->dashboard_sections;
		$dashboard_options_assigned = $this->assigned_options;
		...
		$activated = get_option('rad_uptin_activated');

		if ($activated !== 'uptin_activated') {
			echo '

	<div class="rad_act_scr rad_act_scr_mode_act_code">
				<div class="rad_act_scr_head">
					<div class="rad_act_scr_logo">&nbsp;</div>
					<div class="rad_act_scr_headline rad_act_scr_mode_get_code">Welcome to <i>Uptin.</i></div>
					<div class="rad_act_scr_headline rad_act_scr_mode_act_code"><i>Uptin</i></div>
					...
					<div class="rad_act_scr_message rad_act_scr_mode_get_code">
						To get started, please enter a few details below so we can send you a unique activation code for plugin access. We’ll also provide you with plugin updates, access to the latest Uptin designs, and more.
					</div>
							...
							<input type="hidden" value="' . site_url() . '" class="rad_act_scr_input_site">
					 		<label>
								<input type="checkbox" autocomplete="off"
									class="rad_act_scr_input_box_checkbox">&nbsp;I agree to the <a target="_blank" href="http://www.uptin.com/tou">terms of use</a>.
							<label>
    ...
    <div class="rad_act_thx_you_head">
        <div class="rad_act_thx_you_head_inner">
            ...
            <div id="rad_act_scr_thx_you_tagline">
                <p>Thanks for Joining</p> <h2 class="rad_act_scr_thx_you_rapid">Uptin</h2>
...
<div class="back-to-plugin">
    <a href="javascript:window.location.reload();">No thanks, take me to the Uptin plugin!</a> | <a target="_blank" href="http://www.uptin.com/privacy?utm_campaign=rp-rp&utm_medium=wp-thank-you-privacy">Privacy Policy</a>
</div>
</div>
			';
		} else {
		...
		echo '
		<li class="rad_dashboard_tab_content_header_stats">
						<a href="#tab_rad_dashboard_tab_content_header_stats" id="rad_dashboard_tab_content_header_stats" class="rad_dashboard_icon_header_stats rad_dashboard_icon">
							<span></span>
						</a>
					</li><li class="rad_dashboard_tab_content_header_accounts">
						<a href="#tab_rad_dashboard_tab_content_header_accounts" id="rad_dashboard_tab_content_header_accounts" class="rad_dashboard_icon_header_accounts rad_dashboard_icon">
							<span></span>
						</a>
					</li><li class="rad_dashboard_tab_content_header_importexport">
						<a href="#tab_rad_dashboard_tab_content_header_importexport" id="rad_dashboard_tab_content_header_importexport" class="rad_dashboard_icon_header_importexport rad_dashboard_icon">
							<span></span>
						</a>
					</li><li class="rad_dashboard_tab_content_header_home">
						<a href="#tab_rad_dashboard_tab_content_header_home" id="rad_dashboard_tab_content_header_home" class="rad_dashboard_icon_header_home rad_dashboard_icon">
							<span></span>
						</a>
					</li><li class="rad_dashboard_tab_content_header_edit_account">
						<a href="#tab_rad_dashboard_tab_content_header_edit_account" id="rad_dashboard_tab_content_header_edit_account" class="rad_dashboard_icon_header_edit_account rad_dashboard_icon">
							<span></span>
						</a>
					</li><li class="rad_dashboard_tab_content_header_support">
						<a href="#tab_rad_dashboard_tab_content_header_support" id="rad_dashboard_tab_content_header_support" class="rad_dashboard_icon_header_support rad_dashboard_icon current">
							<span></span>
						</a>
					</li>
							...
							switch( $option[ 'type' ] ) {
								...
								case 'text' :
									...
									printf(
										...
										! empty( $option[ 'button_text' ]) ? '<button class="rad_uptin_textarea_button rad_uptin_'.$button_class_text.'">'.$button_text.'</button>' : ''#11
									);
								break;
								...
								case 'font_select' :
									$fonts_class = EWD_Dash::load_fonts_class();
		...
		if ( isset( $dashboard_sections[ 'header' ][ 'contents' ] ) ) {
			...
			echo uptin_marketing_sidebar(true);
		} // activate screen end
		echo '</div></div>';
