...
/**
 * @return array
 * @description list of all email providers supported in Uptin. This list is used whenc creating a new optin
...
foreach ($email_providers_array as $key => $value){
	$email_providers_new_optin[$key] = __( $value , 'uptin');
}
...
$all_optins = get_option('rad_uptin_options');
