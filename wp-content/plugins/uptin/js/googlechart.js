...
function uptin_chart_init($period, $stats, $list_id){
    google.setOnLoadCallback(uptin_drawChart);
    uptin_drawChart($period, $stats, $list_id);
}

function uptin_drawChart($period, $stats, $list_id){
    ...
    div.setAttribute('class', 'uptin_line_chart');
    var container = document.querySelector('.rad_dashboard_lists_stats_graph_container')
    container.appendChild(div);
    var chart = new google.charts.Line(document.querySelector('.uptin_line_chart'));
