<table class="form-table">
  ...
  <tr valign="top">
    ...
    <td>
      <input type="number" name="entries_per_youtube_subscribe" placeholder="3" class="regular-text" value="<?php echo get_post_meta($post->ID, '_entries_per_youtube_subscribe', true) ?>" />
